                ...
                <form method="POST" action="/users">
                    ...
                    <div class="card-content">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" name="name" id="name" @error('name') is-invalid @enderror  value="{{ old('name') }}">
                        ...
                        <div class="input-field">
                            ...
                            <input type="email" name="email" id="email" @error('email') is-invalid @enderror" value="{{ old('email') }}">
