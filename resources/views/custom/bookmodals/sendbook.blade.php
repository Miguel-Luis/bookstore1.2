<!-- Modal Structure -->
<div id="enviar" class="modal" style="width: 30%; height: 45%; border-radius: 15px;">
    <div class="modal-content center-align">
        <i class="material-icons large" style="color: #ffa000">send</i>
        <h4 style="color: gray">¿Enviar?</h4>
        <p style="color: gray">Enviaras este libro...</p>
    </div>
