            ...
            <div class="row">
                ...
                <div class="col s12 m12 l12">
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input data-length="255" id="name" type="text" class="validate {{ $errors->has('name') ? 'invalid ' : '' }}" name="name" value="{{ old('name', $category->name) }}">
                        ...
                        {{-- Modal --}}
                        @include('custom.categorymodals.editcategory')
                    </div>
                </div>
            </div>
        </form>
